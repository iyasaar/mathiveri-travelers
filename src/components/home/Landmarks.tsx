        ...
        <div className="max-w-6xl mx-auto md:space-y-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="order-2 lg:order-1 self-center">
              ...
              <p className="text-base md:text-lg leading-relaxed mt-4 mr-10">
                Nurse Shark Point in Mathiveri is a popular landmark among
                tourists, known for sightings of nurse sharks and diverse marine
                life. Its located in mathiveri harbor
              </p>
            </div>
            <div className="relative w-full h-80 order-1 lg:order-2">
              <Image
                src="/landmarks/sharkpoint/01.JPG"
                alt="Shark Point"
                fill
                className="object-cover rounded-lg"
              />
