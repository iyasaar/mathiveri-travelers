...
const explore = () => {
  return (
    <div className="min-h-screen">
      {/* Header Section */}
      <div
        className="md:h-[230px] h-[250px] bg-cover bg-center relative"
        style={{
      ...
      >
        <div className="absolute inset-0 bg-black bg-opacity-20 flex items-center justify-center">
          <h1 className="text-white text-4xl font-bold font-serif tracking-wider text-center md:mt-0 mt-12">
